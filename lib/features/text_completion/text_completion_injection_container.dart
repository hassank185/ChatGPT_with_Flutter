...
import 'package:flutter_chat_gpt/features/text_completion/data/remote_data_source/text_completion_remote_data_source_impl.dart';
import 'package:flutter_chat_gpt/features/text_completion/data/repository/text_completion_repository_impl.dart';
...
Future<void> textCompletionInjectionContainer() async{
  ...
  //Futures bloc
  sl.registerFactory<TextCompletionCubit>(() => TextCompletionCubit(textCompletionUseCase: sl.call()));

  //UseCase
  sl.registerLazySingleton<TextCompletionUseCase>(() => TextCompletionUseCase(repository: sl.call()));

  //repository
  sl.registerLazySingleton<TextCompletionRepository>(() => TextCompletionRepositoryImpl(
